...
export default function AtualizaCategoria() {
    ...
    useEffect(() => {
        ...
        api.get(`categorias/${categoriaId}`).then((response) => {
        ...
        <div className="atualiza-categoria-container">
            <div className="content">
                <section>
                    ...
                    <p>
                        Para atualizar um produto, basta selecionar uma nova
                        categoria ou uma nova descrição para o seu produto e
                        clicar em Atualizar.
                    </p>
                ...
                <form onSubmit={handleUpdate}>
                    <input
                        placeholder="Escreva um nome para a Categoria"
                        value={categoriaNome}
